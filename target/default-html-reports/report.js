$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/resources/features/1_AZUL-753.feature");
formatter.feature({
  "name": "Default",
  "description": "",
  "keyword": "Feature",
...
formatter.scenario({
  "name": "User should be able to add users by selecting multiple contacts from Employees and Departments contact lists.",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "User should be able to add users  from Employess and Departments contact lists",
  "keyword": "Then "
});
formatter.match({
  "location": "com.azul.stepdefnitions.PortalPageDefs.user_should_be_able_to_add_users_from_Employess_and_Departments_contact_lists()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "User can attach a link by clicking on the Link icon and save it",
  "keyword": "Then "
});
formatter.match({
  "location": "com.azul.stepdefnitions.PortalPageDefs.user_can_attach_alink_by_clicking_on_the_Link_icon()"
});
formatter.result({
  "status": "passed"
});
...
formatter.result({
  "error_message": "org.junit.ComparisonFailure: expected:\u003c[https://www.youtube.com/watch?v\u003dBRzlyGXx13Q]\u003e but was:\u003c[]\u003e\r\n\tat org.junit.Assert.assertEquals(Assert.java:117)\r\n\tat org.junit.Assert.assertEquals(Assert.java:146)\r\n\tat com.azul.stepdefnitions.PortalPageDefs.user_should_go_to_the_insert_videos_by_clicking_on_the_video_icon_and_enters_the_video_url(PortalPageDefs.java:59)\r\n\tat ✽.User should go to the insert videos by clicking on the video icon and enters the video url(file:///C:/Users/salim/IdeaProjects/Azul-Automation/src/test/resources/features/1_AZUL-753.feature:54)\r\n",
  "status": "failed"
});
